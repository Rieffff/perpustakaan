...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <form role="form" action="{{ url('/cetakCustomPDF2') }}" method="POST">
  @method('post')
  @csrf
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input type="hidden" class="form-control" id="id_siswa" placeholder="Pilih tanggal" name="id_siswa" value="{{ $id_siswa }}">
      </div>
      </div>
    <!-- /.card-body -->
