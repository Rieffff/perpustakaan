  ...
  <table id="example1" class="table table-bordered table-striped" width="100%">
    ...
    <tr>
      ...
      <?php $URL = "/bukuEdit";  ?>
        ...
        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModalLong{{ $row->id_kelas }} ">
        <i class="fa fa-fw fa-edit"></i>
        </button>
      
<!-- modal add -->
<div class="modal fade" id="exampleModalLong{{ $row->id_kelas }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <form role="form" action="kelas/{{ $row->id_kelas }}" method="POST">
  @method('patch')
  @csrf
    <div class="card-body">
      <div class="form-group">
        <label for="judul">kelas</label>
        <input type="text" class="form-control" id="kelas" placeholder="Enter kelas" name="kelas" required value="{{ $row->kelas }}">
      </div>
    </div>
    <!-- /.card-body -->
