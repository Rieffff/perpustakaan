...
<body>
	...
	<header class="header-section">
		<div class="container">
			<!-- logo -->
			<a href="{{ url('/') }}" class="site-logo"><img src="{{ asset('assets/image/logo.png') }}" alt="" style="width:200px; height:80px; margin-top:-23px; "> </a><b style="margin-left:-100px;">SMP NEGERI 1 SITUBONDO</b>
